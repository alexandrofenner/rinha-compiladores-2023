...
var
  i: Integer;
  k0, k1, k2, k3, k4, k5, k6, k7, k8, k9, k10, k11: Int64;
  p: PRecord12;
begin
  ...
  begin
    ...
    and (p.k8 = k8) and (p.k9 = k9) and (p.k10 = k10) and (p.k11 = k11)) then
    begin
